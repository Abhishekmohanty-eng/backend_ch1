...
app.get('/products/filter/ram', (req, res) => {
  const ram = req.query.ram ? req.query.ram.trim().toLowerCase() : '';
  console.log('Query parameter:', ram);

  let filteredProducts = products.filter(product => {
 
    console.log('product.ram type:', typeof product.ram, 'value:', product.ram);
    
    return String(product.ram).trim().toLowerCase() === ram;
  });
...
app.get('/products/filter/rom', (req, res) => {
  const rom = req.query.rom ? req.query.rom.trim().toLowerCase() : '';
  console.log('Query parameter:', rom);

  let filteredProducts = products.filter(product => {

    return String(product.rom).trim().toLowerCase() === rom;
  });
  console.log('Filtered products:', filteredProducts);
